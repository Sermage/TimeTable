...
object DataGenerator {
    ...
    private val literature =
        ObligatoryLesson("Literature", "Joey Tribiani", R.drawable.book_shelf_48, "9:00", "9:45",true)
    private val math = ObligatoryLesson("Mathematics", "Chandler Bing", R.drawable.math_icon, "8:00", "8:45")
    private val history = ObligatoryLesson("History", "Ross Geller", R.drawable.archery, "10:00", "10:45")
    private val physics = ObligatoryLesson("Physics", "Sheldon", R.drawable.physics_icon, "12:00", "12:45")
    ...
    private val compScience =
        ObligatoryLesson("Computer Science", "Thomas Andersen", R.drawable.computer_icon, "16:45", "17:30",true)

    private val actingClass=AdditionalLesson("Acting class","Joey Tribbiani",R.drawable.acting_icon,"11:00","12:00","Seminar from the famous actor \"What is it to be an actor\".")
    private val physicalEducation=AdditionalLesson("Physical Education","Boris Blade",R.drawable.icon_basketball_48,"15:00","16:30","Interactive presentation for the Junior World Championship in Los Angeles.")
    ...
    private val listOfAllLessons= mutableListOf(literature, math, history, physics, chemistry,
